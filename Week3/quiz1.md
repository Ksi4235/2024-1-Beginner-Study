...
- 답: 1번은 두 브랜치를 병합해 새로운 commit을 만들고 2번은 하나의commit으로 main으로 병합됨 3번은 모두 새로운 커밋으로 변경됨  
...
- 답: revert ,reset은 commit을 삭제함으로 위험함